$(document).ready(function(){
    var service_1 = $('#sv_name_1').val();
    var month_1 = $('#month_1').val();
    var year_1 = $('#year_1').val();
    $.ajax({
         type: "GET",
         url: '/leader/data_line_month_'+month_1+'_'+year_1+'_'+service_1,
    ...
    $.ajax({
         type: "GET",
         url: '/leader/data_pie_month_'+month_1+'_'+year_1+'_'+service_1,
         contentType: "application/json; charset=utf-8",
         success: function(response){
            var ctx_2 = $("#bieu_do_2");
    ...
    var service_2 = $('#sv_name_1').val();
    var year_2 = $('#year_2').val();
    $.ajax({
         type: "GET",
         url: '/leader/data_line_year_'+year_2+'_'+service_2,
         contentType: "application/json; charset=utf-8",
         success: function(response){
            var ctx_3 = $("#bieu_do_3");
    ...
    $.ajax({
         type: "GET",
         url: '/leader/data_pie_year_'+year_2+'_'+service_2,
         contentType: "application/json; charset=utf-8",
         success: function(response){
            var ctx_4 = $("#bieu_do_4");
