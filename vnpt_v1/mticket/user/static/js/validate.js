$(document).ready(function(){
    $("#login").click(function(){
        var uname = $("#home input[name=agentname]").val();
        $("#home input[name=agentname]").val(escapeHtml(uname));
        var pass = $("#home input[name=agentpass]").val();
        $("#home input[name=agentpass]").val(escapeHtml(pass));
    });
